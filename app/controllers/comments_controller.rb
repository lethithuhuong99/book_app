class CommentsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @comment.update(comment_params)
        format.html { redirect_to book_path(@comment.book_id), notice: 'Comment was successfully updated.' }
  ...
  def destroy
    @comment.destroy
    respond_to do |format|
      format.html { redirect_to book_path(@comment.book_id), notice: 'Comment was successfully destroyed.' }
  ...
  private
    ...
    def comment_params
      params.require(:comment).permit(:title, :rate, :description, :book_id, :user_id)
    end
end
